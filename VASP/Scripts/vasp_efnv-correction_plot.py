...
"""
Usage:
      python3 vasp_efnv-correction_plot.py
   
Reads the correction.json file produced by vasp_efnv_corrections.py script.
"""
...
correction = ExtendedFnvCorrection(
    charge=data["charge"],
    point_charge_correction=data["point_charge_correction"],
