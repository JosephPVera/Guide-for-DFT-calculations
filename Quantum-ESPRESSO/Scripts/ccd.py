...
ATOMIC_POSITIONS may be 'crystal', 'angstrom' or 'bohr' (not 'alat', see note 
below), and CELL_PARAMETERS may be 'angstrom' or 'bohr'. Internally everything 
is converted to a common representation (cell in Angstrom, positions as 
...
def run_qe(n_images):
    ...
    fractional displacement, so an atom near a cell boundary interpolates 
    along the short physical path instead of wrapping the long way around 
    the cell.
    """
