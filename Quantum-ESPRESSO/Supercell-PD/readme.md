...
$$
\mu^{elemental}_{C} = \frac{E_{C}}{N_{C}} = \frac{-16.633160}{2} = -8.316580 \quad \mathrm{eV/atom}
$$

$$
\mu^{elemental}_{N} = \frac{E_{N}}{N_{N}} = \frac{-16.633160}{2} = -8.316580 \quad \mathrm{eV/atom}
$$
